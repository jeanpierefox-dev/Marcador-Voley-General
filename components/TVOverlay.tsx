          ...
          renderScoreboard && !isPreMatch && !activeShowRotation && (
            <div className={`relative z-10 transition-all duration-300
                ${isVertical 
                    ...
                    : 'absolute bottom-4 md:bottom-8 left-1/2 -translate-x-1/2 w-full max-w-[900px] px-2 md:px-0 pointer-events-none scale-[0.85] md:scale-100 flex justify-center origin-bottom'
                }
            `}
